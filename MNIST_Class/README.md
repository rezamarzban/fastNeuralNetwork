...
For example if want to have 10 hidden layers with sizes: 1000, 500, 300, 200, 400, 600, 800, 100, 50, 2000 neurons at each layer, simply write in the Python code: `hidden_sizes = [1000, 500, 300, 200, 400, 600, 800, 100, 50, 2000]`, Or write in the C++ code: `std::vector<int> hidden_sizes = {1000, 500, 300, 200, 400, 600, 800, 100, 50, 2000};`
