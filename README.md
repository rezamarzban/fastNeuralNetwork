...
Neural Network Implementation with C++ `simpleNN.cpp`:
...
`MNIST_Class`: AI, image classifying multilayer neural network and handwriting digits recognition using MNIST datasets only with numpy, numba, cupy, C++ and etc without TensorFlow and PyTorch.
