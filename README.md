...
`MNIST_Class`: AI, image classifying neural networks and handwriting digits recognition using MNIST datasets only with numpy, numba, cupy, C++ and etc without TensorFlow and PyTorch.
